...
# Mixins
from community.apps.posts.api.views.mixins import (
...
# Main Section
class PostsViewSet(mixins.ListModelMixin, GenericViewSet):
    serializers = {
    ...
    @swagger_auto_schema(
        **swagger_decorator(tag="03. 포스트", id="임시글 일괄 삭제", description="", response={204: "no content"})
    )
...
class PostViewSet(
    ...
    @swagger_auto_schema(
        **swagger_decorator(tag="03. 포스트", id="포스트 조회", description="", response={200: PostRetrieveSerializer})
    )
    ...
    @swagger_auto_schema(**swagger_decorator(tag="03. 포스트", id="포스트 삭제", description="", response={204: "no content"}))
    ...
    @swagger_auto_schema(
        **swagger_decorator(tag="03. 포스트", id="임시글 객체 삭제", description="", response={204: "no content"})
    )
